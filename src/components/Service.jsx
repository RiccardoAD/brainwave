...
import { Gradient, PhotoChatMessage, VideoChatMessage, VideoBar } from "./design/Services";
const Services = () => {
    ...
    <Section id={"how-to-use"}>
      <div className="container">
        ...
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <Generating className="absolute left-4 right-4 bottom-4 lg:left-1/2 lg:right-auto lg:bottom-8 lg:w-[31rem] lg:-translate-x-1/2 border border-n-1/10" />
          </div>
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p8 bg-gradient-to-b from-n-8/0 to-n-8/90 p-8 lg:p-15">
